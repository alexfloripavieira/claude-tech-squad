...
Os orchestradores principais (`/discovery`, `/implement`, `/squad`, `/hotfix`) carregam um **Global Safety Contract** que propaga automaticamente todas essas restrições para cada teammate que spawnam.
