...
description: |
  ...
  <example>
  Context: A repo lacks any CI and the team wants tests to run on every PR.
  user: "Precisamos adicionar pipeline de CI rodando testes e lint em cada PR."
  assistant: "I'll use the ci-cd agent to design the workflow, define quality gates, and wire artifact caching."
  <commentary>
  Pipeline design with quality gates is the core CI/CD specialist responsibility.
  </commentary>
  </example>
